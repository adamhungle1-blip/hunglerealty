      ...
      <div className="mx-auto max-w-7xl px-4 py-14">
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {posts.map((post) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <h3 className="mt-1.5 text-lg font-bold leading-snug text-white group-hover:text-[#c49a2a] transition-colors">
                  {post.title}
                </h3>
                  ...
                  <div className="mt-4 grid grid-cols-3 gap-2 rounded-lg bg-white/5 p-3">
                    {post.stats.map((stat) => (
                      <div key={stat.label} className="text-center">
                        <p className="text-base font-bold text-[#c49a2a]">{stat.value}</p>
          ...
          <div className="hidden overflow-hidden rounded-xl border border-dashed border-white/10 bg-white/[0.02] md:flex md:flex-col md:items-center md:justify-center md:p-8 md:text-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white/10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
            </svg>
            <p className="mt-3 text-sm font-medium text-white/20">More posts coming soon</p>
          </div>
          <div className="hidden overflow-hidden rounded-xl border border-dashed border-white/10 bg-white/[0.02] lg:flex lg:flex-col lg:items-center lg:justify-center lg:p-8 lg:text-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white/10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
            <p className="mt-3 text-sm font-medium text-white/20">New listings &amp; sales</p>
          </div>
        </div>
      </div>
    </section>
