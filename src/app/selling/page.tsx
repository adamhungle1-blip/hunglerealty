...
const services = [
  ...
  },
  {
    ...
    text: "We've built a large database of active buyers over 20 years, including investors and farmers who are always looking for farmland. We can match your property with qualified buyers quickly.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
